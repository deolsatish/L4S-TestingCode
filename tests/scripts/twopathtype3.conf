#!/bin/csh
#
# Launch a two-path rsync where the client initiates a connection
# then pulls data.
#

set testname="twopathtype3"
...
# Run siftr on both hosts (0 disabled, 1 enabled)
set do_siftr = "0"

# Run tcpdump on the client host (0 disabled, 1 enabled)
set do_tcpdump = "1"
